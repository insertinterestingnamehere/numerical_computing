...
We may also use this feature to plot lines that have different ranges on the same plot.
...
%this example is largely based on one of the examples in the matplotlib docs. I have simplified it and changed the way the functions are imported, but we could do a citation anyway.
