...
Write a Python function that, given a nonzero initial point, perturbs the coordinates of the initial point, runs the simulation to a given time $t$, and produces a semilog plot of the norm of the difference between the two solution curves.
