...
\begin{comment}
\begin{problem}
Use your implementation of Cholesky decomposition to solve problem 2. Use the fact when $A$ is positive definite, $Ax=b$ is the same as $L^*Lx=b$ which can be solved by $L^*y=b$ then $Lx=y$.
\end{problem}
\end{comment}
