...
If a persons energy intake is more than their energy expended, then they gain weight.
...
The function \li{weight_odesystem} in the following code implements \eqref{compartment}.
...
y0 = [1 / 2., 1 / 3.] 				# initial conditions

def Lotka_Volterra(x, y):
    return [y[0] * (1. - y[1]), alpha * y[1] * (y[0] - 1.)]

subintervals = 200
# Using the Order 4 Runge-Kutta IVP solver
Y = RK4(Lotka_Volterra, y0, a, b, subintervals)

# Plot the direction field
Y1, Y2 = np.meshgrid(np.arange(0, 4.5, .2), np.arange(0, 4.5, .2), sparse=True, indexing='ij')
