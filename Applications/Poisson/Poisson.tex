...
identity matrix, and $T$ is the tridiagonal matrix
 ...
 The vectors $p$ and $q$ come from the boundary conditions of \eqref{2d_poisson}, and are given by 
\[ 
...
\]
 ...
 \[
 p^j = \frac{1}{h^2}
 \begin{bmatrix} g_{-1,\,j} \\ 0 \\ \vdots \\0\\ g_{N-1,\,j} \end{bmatrix} , \,\,\, 0 \leq j \leq N-2,
 \]
 and 
 \[
