...
\begin{figure}
\begin{center}
\subfloat[Proportional log probs when $\beta = 1$.]{\label{figur:1}\includegraphics[height=1.75in]{beta1_logprobs.jpeg}}
\subfloat[Spin configuration sample when $\beta = 1$.]{\label{figur:2}\includegraphics[height=1.75in]{beta1_sample.jpeg}} \\
\subfloat[Proportional log probs when $\beta = 0.2$.]{\label{figur:3}\includegraphics[height=1.75in]{beta02_logprobs.jpeg}}
\subfloat[Spin configuration sample when $\beta = 0.2$.]{\label{figur:4}\includegraphics[height=1.75in]{beta02_sample.jpeg}}
\end{center}
\end{figure}