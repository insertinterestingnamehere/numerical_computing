...
Adjust your algorithm from problem 1 to handle sparse matrices (use \li{eigs(matrix, k=2, which="SR")}) in the linalg library of \li{scipy.sparse} to find the eigenvalues and eigenvectors).
