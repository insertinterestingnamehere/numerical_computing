...
%Add citation for Notre Dame file http://snap.stanford.edu/data/web-NotreDame.html
%Reference SNAP
...
\begin{problem}
Calculate the PageRank on the first 3500 web pages in the data set. Remember that first you must set any rows that are all zeros to be rows of ones. Which page has the highest page rank, and what is the value of the page rank? Which method works the best? Why?
\label{prob:pg_calc}
\end{problem}
