...
\begin{problem}
What are the demand levels for the three product economy? This can be solved for either using the \li{scipy.lstsq()} function and the coefficient matrix or by directly using the raw data.
\end{problem}
