...
closing the file once you are done processing and exit the block. We next created a \li{csv.reader} object around 
...
filling value, the \li{filling_values} argument should be set to this single filling value.

If for some reason we want to omit certain rows in the csv file, we can use the \li{skip_header} or \li{skip_footer} 
