...
We can accordingly use \li{linalg.solve()} to predict how changes in demand will affect overall production.

\begin{problem}
What are the demand levels for the three product economy?
This can be solved for either using the \li{linalg.solve()} function and the coefficient matrix or by directly using the raw data.
\end{problem}
