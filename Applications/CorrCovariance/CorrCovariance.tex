...
\end{lstlisting}
%I see no reason to re-write what Y is, as it is given clearly in the code listing.
%Hence we have:
%\[
%Y=
%\begin{bmatrix}
...
% the matrix is indeed only positive semi-definite. It still has a Cholesky decomposition in theory, although I think it can only be
% computed for positive definite matrices.
