...
Three basic operators in logic are \li{and} (\&), \li{or} {\textbar\textbar), and \li{not} (\!{}). We can use relational operators from the~\ref{tbl:relops} to build logical statements.
