...
On the client side, we create another socket 
...
\hline
/join & GET & Join switch to another \\
/nick & & Change the user's nickname \\
/quit & & Quit the message board \\
/pull & GET & Check for new messages and display them to the user\\
/push & POST & Publish a new message on the message board \\
/create & POST & Create a new channel on the server \\
\hline
\end{tabular}
\end{table}
