...
Feel free to look through the documentation \href{http://docs.python.org/2/library/itertools.html}{here}.
...
If the array cannot be evenly divided into sub-blocks, raise and error.
...
It wouldraise an error if I were to ask for that sort of stepping on an array with 10 entries since the last item could not be included in any subblock.
\end{problem}
