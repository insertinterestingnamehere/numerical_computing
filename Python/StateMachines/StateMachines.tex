...
\begin{problem}
The emphatic prince has decreed that all sentence punctuation be replaced by exclamation marks.
If the sentence is a question, the question mark remains and the exclamation mark is added immediately after (i.e. ``How are you?'' transforms to ``How are you?!'').  
\end{problem}
