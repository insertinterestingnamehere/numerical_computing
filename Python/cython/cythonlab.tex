...
You can also specify more about the memory layout of the array using the additional argument \li{mode} to specify whether the array is C-contigous, Fortran-contiguous, full, or strided (some of what this means will be explained later).
