...
This is because matrix multiplication in SciPy runs using LAPACK, which is a heavily optimized set of Fortran routines for doing linear algebra using arrays.
