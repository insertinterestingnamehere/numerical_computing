...
\li{self.color} is an instance variable. It is defined for a particular instance of a backpack.
We can also change it outside of the class definition.
We can instantiate a \li{Backpack} object of the color purple. If we do not specify than it will default to black.
...
In \li{Backpack}, out data is the color and list of contents while the methods are \li{put()} and \li{take()} along with the more hidden magic methods.
