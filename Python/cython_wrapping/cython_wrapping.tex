...
\lstinputlisting[style=fromfile, language=C]{ctridiag.h}
...
\lstinputlisting[style=fromfile, language=Python]{cython_ctridiag.pyx}
...
\lstinputlisting[style=fromfile, language=Python]{ctridiag_setup_windows64.py}

The following file should work on Linux and Macintosh machines using gcc.

\lstinputlisting[style=fromfile, language=Python]{ctridiag_setup_linux.py}
...
\lstinputlisting[style=fromfile, language=Python]{ctridiag_setup_distutils.py}
...
\lstinputlisting[style=fromfile, language=Python]{ctridiag_test.py}
