...
Some of these declaration files allow Cython code to interface with containers from the C++ standard template library like \li{deque}, \li{list}, \li{map}, \li{pair}, \li{queue}, \li{set}, \li{stack}, \li{string}, \li{utility}, and \li{vector}.
