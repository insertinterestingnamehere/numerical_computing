...
Use keyword arguments to pass \li{fssor} a default tolerance of \li{1e-8} and a default maximum number of iterations of \li{10000}.
...
Generate a 3D plot of \li{U} after it has been modified by the function \li{cyssor}.
...
Notice that the integer \li{info} is still passed as a pointer because the function needs to be able to modify it.
\end{problem}
