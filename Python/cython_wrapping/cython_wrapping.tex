...
This file can be compiled to a \li{.o} file so that \texttt{ctridiag} can be called by other programs. To do this, we run the following command in a terminal:
...
Once we have run this command the file has been compiled to a \of file, but it is still inaccessible from Python.
