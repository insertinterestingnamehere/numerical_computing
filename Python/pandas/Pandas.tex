...
Once we have our data ready to go in pandas, how can we view it or gain access to certain parts of it?
In this section we will explore some elementary plotting and querying techniques that enable us to maneuver through
...
The DataFrame, being a tabular data structure, bears an obvious resemblance to a typical relational
...
Of course, the whole point of \li{pandas} is to help you \emph{analyze} the data once it's inputted. 
Several upcoming labs will involve practicing different ways of using pandas for data analysis. 
We'll just cover the very basics right now.
