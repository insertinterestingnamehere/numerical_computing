...
Therefore, we can check to see if our script is being executed and not imported by some other module by checking if \li{__name__} has the value of \li{__main__}.  We can ue this to modify the behavior of the script.
