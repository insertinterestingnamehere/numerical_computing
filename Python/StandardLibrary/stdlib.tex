...
Some of the more commonly used functions of the \li{random} module are demonstrated below.
\begin{lstlisting}
import random
...
# Finally you can register a dialect with the csv module.
...
with open('test.csv', 'r') as csv_file:
    ...
    # You can now work with the reader object alone.
