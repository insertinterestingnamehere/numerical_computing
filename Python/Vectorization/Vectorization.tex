...
For example, 0 becomes 255, 230 becomes 25, and 127 becomes 128.
...
\item Grayscale:
To convert an image to grayscale, each pixel's color value is changed to the average of the pixel's red, green, and blue value.
For example, if the pixel values are Red: 225, Green:, 30 Blue: 131, we set each of these values to $\frac{225 + 30 + 131}{3} = 128$ (using integer division).
