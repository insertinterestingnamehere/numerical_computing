...
Look at the documentation for the \li{opt.basinhopping} function online and use it to find the global minimum of our \li{multimin} function with the same \li{x0}. 
...
The \li{optimization} package also has functions useful in root-finding. 
