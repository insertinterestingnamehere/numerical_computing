...
\begin{itemize}
\item Why does \li{7/3 == 2} ? 
\item How do you create a complex number? Is it possible to extract just the real part or just the imaginary part? If so, how?
\item What happens in \li{string[::9]} and \li{string[27:0:-1]} provided that \li{string = "I love the new ACME program"}?
\item If \li{a = ["mushrooms", "rock climbing", 1747, .07889, "yoga"]}
\begin{itemize}
...
\item How important is proper spacing and indenting in your code (especially in loops)?
...
\item What is the difference between a key word argument (kwag) and positional argument?
...
\item What is the purpose of object-oriented programming?
\end{itemize}
