...
\node[draw=none, node distance = 3.5cm][below of=98]{};
...
As we saw in problem \ref{prob:Linear probing insert}, with linear probing, elements in the table will cluster together.
...
We can easily add a load factor to our \li{HashTable} class:
\begin{lstlisting}
def load(self):
