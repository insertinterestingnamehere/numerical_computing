...
For this lab, we will use Python's built-in \li{hash} function.
...
\begin{problem}
Add an insert method to your \li{HashTable} class. Don't forget to update your size for the number of elements within the hashtable!
