...
Both storing and retrieving data take time. As the size of our data set grows, 
so too does the time it takes to manipulate it -- be that growth logarithmic, 
...
However, the performance of all of the abstract data types slows down as the 
...
Nodes can store absolutely anything, and what they contain will depend on the 
data structure and what data is being stored.
