...
We can access ranges of elements using Python lists.  NumPy, though, has a much faster, more concise way to select ranges using the \li{arr[start:stop:step]} notation.  Using lists to access various parts of an array is very slow (by at least an order of magnitude)!
...
array([ 1,  6, 11, 16, 21])
: arr[:, [1]] #extract second column, but keep 2 dimensions. Slow!
array([[ 1],
       [ 6],
       [11],
       [16],
