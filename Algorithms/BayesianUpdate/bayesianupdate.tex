...
\begin{figure}
\begin{center}
\subfloat[Prior distribution for $\mu$.]{\label{figur:1}\includegraphics[height=1.75in]{mean_prior.jpeg}}
\subfloat[Prior distribution for $\sigma^{2}$.]{\label{figur:2}\includegraphics[height=1.75in]{variance_prior.jpeg}}
