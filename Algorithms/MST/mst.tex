...
For the above graph in Figure 8.1 we generate the following matrix:
...
Figure \ref{mst:graph2} shows a spanning tree of the graph shown in \ref{mst:graph1}.
...
It will be \li{\{A:[(B, 3), (F, 6)], B:[(A, 3), (C, 5), (F, 4)], C:[(B, 5), (D, 1), (E, 1), (F, 5)], D:[(C, 1), (E, 2)], E:[(C, 1), (D, 2), (F, 4)], F:[(A, 6), (B, 4), (C, 5), (E, 4)]\}}.
...
As we iterated over the edges in our initialization step we were also able to find the shortest edge.
