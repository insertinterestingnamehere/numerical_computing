...
including 5.  This is standard Python behavior.  The \li{arange()} method
also allows us to specify step size
...
icosahedron.  This soccer ball like shape is found in certain types of carbon
molecules known as fullerenes (specifically $C_{60}$, shown in shaped 
 
%---REMOVE PROBLEM?---
\begin{problem}
The bucky matrix represents the connections
between the vertices of a truncated icosahedron. This structure matches both the
...
\begin{center}
    ...
    \li{min} & Returns minimum entries & A.min(axis)\\
