...
Another common hallmark of quadriture is that it can be used adaptively.
It is common in practice to refine the points of a quadriture estimate on an interval where a function is observed to be changing rapidly.
...
We can use quadriture integration to estimate the probability that a normally distributed random variable will take a value below a given point.
