...
Write a function that will accept a function $f$ and an interval $[a,b]$ and returns a function $g$ on $[-1,1]$ that has the same integral as $f$.  Plot $f$ on $[a,b]$ and $g$ on $[-1,1]$.
