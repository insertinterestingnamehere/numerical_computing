...
\li{lu} computes the LU decomposition.
...
\li{lu_solve} uses the output from \li{lu_factor} and uses it to solve a linear system.

Using \li{lu_factor} and \li{lu_solve} provide a good alternative for inverting large matrices since it is much faster to compute the LU decomposition than it is to invert a matrix.
