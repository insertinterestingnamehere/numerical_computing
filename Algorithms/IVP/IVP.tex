...
% We will begin studying the mathematical model in the context of a spring-mass system.
% We will describe the construction of this mathematical model in the context of a spring-mass sytem; we will then analyze its mathematical properties using the RK4 algorithm constructed in the last lab. 
