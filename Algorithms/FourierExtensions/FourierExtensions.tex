...
the submodule \li{pyfftw.interfaces.scipy_fftpack} mimics the \li{scipy.fftpack} module, containing
...
%%Include some pictures of various cepstra
...
%%Include picture of a hamming window
...
\begin{problem}
Write a function \li{2dFFT} that accepts a two-dimensional array as input and returns the two-dimensional
Fourier Transform of the input. You may use built-in methods to calculate the one-dimensional Fourier
Transform.

Write another function \li{2dIFFT} that accepts a two-dimensional array as input and returns the two-
...
%%Include some plots of the 2D FFT data. 
