...
Also, to avoid getting an erroneous verticle line in the plot you generate, plot the portions of each sheet that have positive and negative real part separately.
\end{problem}