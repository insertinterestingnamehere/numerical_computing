...
\begin{problem}
Write a Cython function that implements the above algorithm.
...
This algorithm is based primarily on for loops and array lookups, so it will be much faster if it is written in Cython.
...
Using the speed results you get from the first implementation we gave you, estimate how long it would take that function to process that many points.
\end{problem}
