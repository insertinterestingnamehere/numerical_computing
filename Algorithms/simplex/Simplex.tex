...
%TODO:
% * Use a more pedagogical explanation of simplex algorithm
% * Make each function (or part) of simplex algorithm a seperate problem
% * Explain the tableau method of storing the linear program and its constraints
