...
\begin{problem}
Test your implementation with random matrices. Try real, complex, symmetric, and Hermitian. Compare your output to the output of \li{linalg.eig}. How many iterations are necessary? How large can $A$ be?
\end{problem}
