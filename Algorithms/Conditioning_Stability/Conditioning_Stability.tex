...
\begin{problem}
Use Python to calculate condition numbers of various matrices. What's the worst conditioned matrix you can find?
\end{problem}
...
We will now consider an example of unstable algorithm.
Consider
