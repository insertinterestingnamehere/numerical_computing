...
\end{split}
\end{equation*}
Plot your solution. (Compare with Figure \eqref{prob:shooting2}.) What is an appropriate initial guess? 
\end{problem}
...
\caption{Two solutions of the system of equations \eqref{eqn:cannon_DEs}, both with initial conditions  $y(0) = 0 \text{m},$ $ v(0) = 45 \text{ m/s},$ and $\theta(0)=\pi/3$. The black curve is the trajectory of a projectile immune to air resistance ($\nu = 0$). The red curve describes the trajectory of a more realistic projectile ($\nu = .0003$). }
