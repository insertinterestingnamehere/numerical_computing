...
\end{comment}
Figures \ref{fig:inv_color} and \ref{fig:exp_inv_color} all show color plots that have been generated using this approach.
This is one of a variety of ways to produce color plots that represent complex valued functions.

\begin{figure}
\begin{subfigure}{.5\textwidth}
\includegraphics[width=\textwidth]{inveresez.png}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
\caption{Color plot representation of $\frac{1}{z}$ and $\frac{1}{z^4}$ about the origin.}
\end{subfigure}
\label{fig:inv_color}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{invez.png}
\caption{Color plot representation of $e^{\frac{1}{z}}$ and about the origin.
This is an essential singular point.}
\label{fig:exp_inv_color}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{invez2.png}
\caption{Color plot representation of $e^{\frac{1}{z^2}}$ about the origin.
This is an essential singular point.}
