...
\BEGIN
   ...
   v_k = v_k / \norm{v_k} \\
   R[k:,k:] -= 2 v_k \left( v_k^\mathsf{H} R[k:,k:] \right) \\
   Q[k:] -= 2 v_k \left( v_k^\mathsf{H} Q[k:] \right) \\
\END \\
\text{return } Q^\mathsf{H} , R
\end{pseudo}
...
\BEGIN
   ...
   v_k /= \norm{v_k} \\
   H[k+1:,k:] -= 2 v_k \left( v_k^\mathsf{H} H[k+1:,k:] \right) \\
   H[:,k+1:] -= 2 \left( H[:,k+1] v \right) v^\mathsf{H} \\
   Q[k+1:] -= 2 v_k \left( v_k^\mathsf{H} Q[k+1:] \right) \\
\END \\
\text{return } Q^\mathsf{H} , R
\end{pseudo}
