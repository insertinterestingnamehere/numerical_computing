...
% Note: technically you can apply Householder reflections on pairs of rows in this way as well.
% When operating on pairs of rows, the approaches are equivalent (except for the signs of the entries in each orthogonal matrix).
% The important part is really how we iterate over the array.
