...
\]
Calling \li{add_pic} many times and different places will build the measurement matrix as well as the measurements. You can return these by
\begin{lstlisting}
...
In the file \li{StudentEarthData.npz}, we have given you the faces, vertices, colors, and the inverse fourier matrix, (accessed by the key \li{'faces'}, \li{'vertices'}, \li{'C'}, and \li{'V'} respectively),
