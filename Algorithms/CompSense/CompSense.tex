...
You also need to load in the arrays corresponding to the keys \li{'vertices'},
\li{'facet'}, and \li{'V'} in the data archive
\li{StudentEarthData.npz}. We assume the variable holding these arrays are named \li{vert}, \li{f},
and \li{V},
respectively.
Execute the following (assuming that the variable holding the array
