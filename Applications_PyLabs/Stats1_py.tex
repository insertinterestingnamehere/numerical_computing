...
\begin{lstlisting}
lab8 = sp.genfromtxt("lab8.txt")
\end{lstlisting}
The data is now available in the array {\tt lab8} (also, make sure Python is working in the directory of lab8.txt).  {\tt lab8} consists of two columns.  Find the correlation coefficient of the two columns.  Then plot the original data and see if the value that you got is reasonable.
\end{problem}
