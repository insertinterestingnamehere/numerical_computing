...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{./Applications_MATLabs/ConfMaps/map1}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{./Applications_MATLabs/ConfMaps/map2}
\caption{bla bla bla}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.33]{./Applications_MATLabs/ConfMaps/map3}
\includegraphics[scale=0.33]{./Applications_MATLabs/ConfMaps/map4}
