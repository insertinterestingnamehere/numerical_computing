...
\part{Bifurcation}
\subimport{./Algorithms/Continuation/}{Continuation}

\part{Parabolic PDE's}
\subimport{./Applications/HeatEqn/}{finitedifference1}
\subimport{./Applications/AnisotropicDiffusion/}{AnisotropicDiffusion}

\part{Elliptic PDE's}
 % \subimport{./Algorithms/finitedifference2/}{finitedifference2}
