...
Humpherys as the owner of this work as well as the web address to 
...
\include{./Algorithms_Combined/Transformations} %Needs to be written
...
\include{./Algorithms_Combined/Iterative1}%Needs to be written
\include{./Algorithms_Combined/Iterative2}%Needs to be written
