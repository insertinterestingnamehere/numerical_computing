...
\subimport{./Applications/MarkovGraph/}{MarkovGraph}
...
\subimport{./Algorithms/EigSolver/}{Eig}
...
\subimport{./Algorithms/NumDeriv/}{FiniteDiff}
\subimport{./Applications/BeamBuckle/}{Beams}
\subimport{./Algorithms/MultiDeriv/}{FiniteDiff2}
...
\subimport{./Algorithms/complexnumbers/}{complexnumbers}
\subimport{./Algorithms/residues/}{residues}

\part{Spectral Calculus}
\subimport{./Applications/PageRank/}{PageRank}
\subimport{./Algorithms/arnoldi_iteration/}{arnoldi_iteration}
\subimport{./Algorithms/GMRES/}{GMRES}
