...
\include{./Algorithms_Labs/Matrices1}
\include{./Algorithms_Labs/Matrices2}

\include{./Algorithms_Labs/Functions}
\end{matlab}
...
\begin{matlab}
\include{./Algorithms_Labs/Conditionals}
\include{./Algorithms_Labs/Complexity}
\end{matlab}
...
\begin{matlab}
\include{./Algorithms_Labs/Functions2}
\include{./Applications_Labs/Vectorization}

\include{./Applications_Labs/Recursion}
\include{./Algorithms_Labs/Profiler}
\end{matlab}
...
\begin{matlab}
\include{./Algorithms_Labs/SciViz}%Not yet written
\end{matlab}
...
\begin{matlab}
\include{./Algorithms_Labs/GraphicsHandles}%Needs to be written
\include{./Applications_Labs/TimeDelay}%Needs to be written

\include{./Algorithms_Labs/Motion3D}%Needs to be written
\end{matlab}
