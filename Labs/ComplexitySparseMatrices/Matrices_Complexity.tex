...
Finally, we remark that to multiply sparse matrices, you must use the \li{dot()} function of the NumPy module, i.e., \li{np.dot()}. 
Unlike NumPy arrays, sparse matrices do not have a \li{dot()} method.
