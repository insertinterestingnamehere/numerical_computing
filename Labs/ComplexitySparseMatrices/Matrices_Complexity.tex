...
You can multiply two sparse matrices elementwise with the \li{multiply()} method of one of the sparse matrices.
\begin{lstlisting}
...
You can also use \li{dot()} method of one of the sparse matrices. 
