...
\[
\widehat{\gamma}_{T,:} = \frac{\widehat{\alpha}_{T,:}\odot \widehat{\beta}_{T,:}}{\sum_{i=1}^N \widehat{\alpha}_{T,i}\widehat{\beta}_{T,i}}.
\]
...
\begin{align*}
A'_{i,j} &= \frac{\sum_{t=1}^{T-1}\widehat{\delta}_{t,j,i}}{\sum_{t=1}^{T-1}\widehat{\gamma}_{t,i}}\\
B'_{i,j} &= \frac{\sum_{t=1}^{T}\widehat{\gamma}_{t,i}1_{\{O_t=j\}}}{\sum_{t=1}^{T}\widehat{\gamma}_{t,i}}\\
