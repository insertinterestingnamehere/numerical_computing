\lab{Weightloss and Predator-Prey Models}{Weightloss and Predator-Prey Models}
...
Note that provided code requires quantities in metric units (kilograms, meters, days) while our graph is converted to units of pounds and days.
\end{problem}
