...
\subimport{./Labs/BSplines/}{bezier}
\subimport{./Labs/BSplines/}{bsplines}
\subimport{./Python/Vectorization/}{Vectorization}
\subimport{./Labs/LineSweep/}{linesweep}
\subimport{./Python/Caches/}{Caches}
\subimport{./Labs/Broyden/}{Broyden}
...
\subimport{./Labs/Knapsack/}{Knapsack}
\subimport{./Labs/MoorePenrose/}{MPApp}
\subimport{./Labs/NormsGeometry/}{Norms_Geometry}
\subimport{./Labs/Leontief/}{Leontief}
\subimport{./Labs/BeamBuckle/}{Beams}
